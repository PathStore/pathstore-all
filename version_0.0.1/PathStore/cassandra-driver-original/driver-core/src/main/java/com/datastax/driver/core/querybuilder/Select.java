...
public class Select extends BuiltStatement {
    ...
    protected Select(String keyspace, String table, List<Object> columnNames, boolean isDistinct, boolean isJson) {
        this(keyspace, table, null, null, columnNames, isDistinct, isJson);
    }

    protected Select(TableMetadata table, List<Object> columnNames, boolean isDistinct, boolean isJson) {
    ...
    protected Select(String keyspace,
           String table,
