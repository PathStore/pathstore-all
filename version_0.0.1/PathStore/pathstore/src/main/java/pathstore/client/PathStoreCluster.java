...
/**
 * This is the main class that represents the Cluster as a whole.
 * This class allows you to interact with the local Path store session through {@link PathStoreSession}
 *
 * @see #getInstance()
...
public class PathStoreCluster {
     ...
     * <p>
     * Creates an instance of a path store cluster to be used throughout the program.
     * This allows for calling this function to get the instance instead of passing the instance around
     *
     ...
     * <p>
     * First we create a cluster TODO: explain the cluster
     * and instantiate {@link #session}
     */
